...
export const LightBloom: React.FC<LightBloomProps> = (props) => {
    const {
        style,
        variant = "shafts",
        direction = "bottom",
    ...
    vRef.current = {
        ...
        base: parseColor(baseColor, [0.78, 0.64, 0.3]),
        accent: parseColor(accentColor, [1, 1, 1]),
    ...
    useEffect(() => {
        ...
        const onEnter = () => { ptrRef.current.onTarget = 1; };
        const onLeave = () => { ptrRef.current.onTarget = 0; };
